                          ...
                          const Vector3f &dir, float &tnear, float &u, float &v)
{
    ...
    // Vector3f point = orig + dir * t;

    // Vector3f v0up = normalize(crossProduct((v0 - v1), (v0 - point)));
    // Vector3f v1up = normalize(crossProduct((v1 - v2), (v1 - point)));
    // Vector3f v2up = normalize(crossProduct((v2 - v0), (v2 - point)));

    // return equal(v0up,v1up)&& equal(v1up,v2up);
